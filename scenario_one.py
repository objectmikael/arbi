...
def main():
    ...
    bitcoin_shares = (wallet*.07) / (sum(bitcoin_ask_values)/len(bitcoin_prices))
    ethereum_shares = (wallet*.11) / (sum(ethereum_ask_values)/len(ethereum_prices))
    polygon_shares = (wallet*.58) / (sum(polygon_ask_values)/len(polygon_prices))
    solana_shares = (wallet*.04) / (sum(solana_ask_values)/len(solana_prices))
    xrp_shares = (wallet*.2) / (sum(xrp_ask_values)/len(xrp_prices))
